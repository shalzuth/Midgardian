...
namespace SDK.Script.AnimationSharingSDK
{
    ...
    {
        public AnimSharingStateInstance(ulong addr) : base(addr) { }
    ...
    {
        public AnimSharingTransitionInstance(ulong addr) : base(addr) { }
    ...
    {
        public AnimSharingAdditiveInstance(ulong addr) : base(addr) { }
    ...
    {
        public AnimSharingInstance(ulong addr) : base(addr) { }
    ...
    {
        public AnimationSharingManager(ulong addr) : base(addr) { }
    ...
    {
        public AnimationSharingSetup(ulong addr) : base(addr) { }
    ...
    {
        public AnimationSharingStateProcessor(ulong addr) : base(addr) { }
    ...
    {
        public TickAnimationSharingFunction(ulong addr) : base(addr) { }
    }
    public class AnimationSharingScalability : Object
    {
        public AnimationSharingScalability(ulong addr) : base(addr) { }
    ...
    {
        public PerSkeletonAnimationSharingSetup(ulong addr) : base(addr) { }
    ...
    {
        public AnimationStateEntry(ulong addr) : base(addr) { }
    ...
    {
        public AnimationSetup(ulong addr) : base(addr) { }
