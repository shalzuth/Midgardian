...
namespace SDK.Script.MediaAssetsSDK
{
    ...
    {
        public MediaSource(ulong addr) : base(addr) { }
    ...
    {
        public BaseMediaSource(ulong addr) : base(addr) { }
    ...
    {
        public FileMediaSource(ulong addr) : base(addr) { }
    ...
    {
        public MediaBlueprintFunctionLibrary(ulong addr) : base(addr) { }
    ...
    {
        public MediaComponent(ulong addr) : base(addr) { }
    ...
    {
        public MediaTimeStampInfo(ulong addr) : base(addr) { }
    ...
    {
        public MediaPlayer(ulong addr) : base(addr) { }
    ...
    {
        public MediaPlaylist(ulong addr) : base(addr) { }
    ...
    {
        public MediaSoundComponent(ulong addr) : base(addr) { }
    ...
    {
        public MediaTexture(ulong addr) : base(addr) { }
    ...
    {
        public PlatformMediaSource(ulong addr) : base(addr) { }
    ...
    {
        public StreamMediaSource(ulong addr) : base(addr) { }
    ...
    {
        public TimeSynchronizableMediaSource(ulong addr) : base(addr) { }
    ...
    {
        public MediaCaptureDevice(ulong addr) : base(addr) { }
    ...
    {
        public MediaSoundComponentSpectralData(ulong addr) : base(addr) { }
