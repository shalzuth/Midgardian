...
namespace SDK.Script.SlateSDK
{
    ...
    {
        public ButtonWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public CheckBoxWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ComboBoxWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ComboButtonWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public EditableTextBoxWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public EditableTextWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ProgressWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ScrollBarWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ScrollBoxWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public SlateSettings(ulong addr) : base(addr) { }
    ...
    {
        public SpinBoxWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public TextBlockWidgetStyle(ulong addr) : base(addr) { }
    ...
    {
        public ToolMenuBase(ulong addr) : base(addr) { }
    }
    ...
    {
        public VirtualKeyboardOptions(ulong addr) : base(addr) { }
    ...
    {
        public InputChord(ulong addr) : base(addr) { }
    ...
    {
        public Anchors(ulong addr) : base(addr) { }
    ...
    {
        public CustomizedToolMenu(ulong addr) : base(addr) { }
    ...
    {
        public CustomizedToolMenuNameArray(ulong addr) : base(addr) { }
    ...
    {
        public CustomizedToolMenuSection(ulong addr) : base(addr) { }
    ...
    {
        public CustomizedToolMenuEntry(ulong addr) : base(addr) { }
        public ECustomizedToolMenuVisibility Visibility { get { return (ECustomizedToolMenuVisibility)this[nameof(Visibility)].GetValue<int>(); } set { this[nameof(Visibility)].SetValue<int>((int)value); } }
    }
}
