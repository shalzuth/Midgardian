...
namespace SDK.Script.DatasmithContentSDK
{
    ...
    {
        public DatasmithObjectTemplate(ulong addr) : base(addr) { }
    }
    public class DatasmithActorTemplate : DatasmithObjectTemplate
    {
        public DatasmithActorTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithAdditionalData(ulong addr) : base(addr) { }
    }
    public class DatasmithAreaLightActor : Actor
    {
        public DatasmithAreaLightActor(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithAreaLightActorTemplate(ulong addr) : base(addr) { }
        public EDatasmithAreaLightActorType LightType { get { return (EDatasmithAreaLightActorType)this[nameof(LightType)].GetValue<int>(); } set { this[nameof(LightType)].SetValue<int>((int)value); } }
        public EDatasmithAreaLightActorShape LightShape { get { return (EDatasmithAreaLightActorShape)this[nameof(LightShape)].GetValue<int>(); } set { this[nameof(LightShape)].SetValue<int>((int)value); } }
        public Vector2D Dimensions { get { return this[nameof(Dimensions)].As<Vector2D>(); } set { this["Dimensions"] = value; } }
        public LinearColor Color { get { return this[nameof(Color)].As<LinearColor>(); } set { this["Color"] = value; } }
    ...
    {
        public DatasmithStaticMeshGLTFImportData(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithFBXSceneImportData(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithDeltaGenAssetImportData(ulong addr) : base(addr) { }
    }
    public class DatasmithDeltaGenSceneImportData : DatasmithFBXSceneImportData
    {
        public DatasmithDeltaGenSceneImportData(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithVREDAssetImportData(ulong addr) : base(addr) { }
    }
    public class DatasmithVREDSceneImportData : DatasmithFBXSceneImportData
    {
        public DatasmithVREDSceneImportData(ulong addr) : base(addr) { }
        public bool bMergeNodes { get { return this[nameof(bMergeNodes)].Flag; } set { this[nameof(bMergeNodes)].Flag = value; } }
        public bool bOptimizeDuplicatedNodes { get { return this[nameof(bOptimizeDuplicatedNodes)].Flag; } set { this[nameof(bOptimizeDuplicatedNodes)].Flag = value; } }
    ...
    {
        public DatasmithIFCSceneImportData(ulong addr) : base(addr) { }
    }
    public class DatasmithStaticMeshIFCImportData : DatasmithStaticMeshImportData
    {
        public DatasmithStaticMeshIFCImportData(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithAssetUserData(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCineCameraActorTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCineCameraComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithContentBlueprintLibrary(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCustomActionBase(ulong addr) : base(addr) { }
    }
    public class DatasmithDecalComponentTemplate : DatasmithObjectTemplate
    {
        public DatasmithDecalComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithImportedSequencesActor(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithOptionsBase(ulong addr) : base(addr) { }
    }
    public class DatasmithCommonTessellationOptions : DatasmithOptionsBase
    {
        public DatasmithCommonTessellationOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithImportOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithLandscapeTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithLightComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithMaterialInstanceTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithPointLightComponentTemplate(ulong addr) : base(addr) { }
        public ELightUnits IntensityUnits { get { return (ELightUnits)this[nameof(IntensityUnits)].GetValue<int>(); } set { this[nameof(IntensityUnits)].SetValue<int>((int)value); } }
        public float SourceRadius { get { return this[nameof(SourceRadius)].GetValue<float>(); } set { this[nameof(SourceRadius)].SetValue<float>(value); } }
        public float SourceLength { get { return this[nameof(SourceLength)].GetValue<float>(); } set { this[nameof(SourceLength)].SetValue<float>(value); } }
        public float AttenuationRadius { get { return this[nameof(AttenuationRadius)].GetValue<float>(); } set { this[nameof(AttenuationRadius)].SetValue<float>(value); } }
    ...
    {
        public DatasmithPostProcessVolumeTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithScene(ulong addr) : base(addr) { }
    }
    public class DatasmithSceneActor : Actor
    {
        public DatasmithSceneActor(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithSceneComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithSkyLightComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithSpotLightComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithStaticMeshComponentTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithStaticMeshTemplate(ulong addr) : base(addr) { }
    ...
    public enum EDatasmithImportHierarchy : int
    {
        UseMultipleActors = 0,
        UseSingleActor = 1,
        UseOneBlueprint = 2,
    ...
    {
        public DatasmithCameraLookatTrackingSettingsTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithPostProcessSettingsTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCameraFocusSettingsTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCameraLensSettingsTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithCameraFilmbackSettingsTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithTessellationOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithRetessellationOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithImportBaseOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithStaticMeshImportOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithAssetImportOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithReimportOptions(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithStaticParameterSetTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithMeshSectionInfoMapTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithMeshSectionInfoTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithStaticMaterialTemplate(ulong addr) : base(addr) { }
    ...
    {
        public DatasmithMeshBuildSettingsTemplate(ulong addr) : base(addr) { }
