...
namespace SDK.Script.AkAudioSDK
{
    ...
    {
        public AkAudioType(ulong addr) : base(addr) { }
    ...
    {
        public AkPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkAndroidPlatformInfo : AkPlatformInfo
    {
        public AkAndroidPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkAssetData : Object
    {
        public AkAssetData(ulong addr) : base(addr) { }
    ...
    {
        public AkAssetDataWithMedia(ulong addr) : base(addr) { }
        public Array<Object> MediaList { get { return new Array<Object>(this[nameof(MediaList)].Address); } }
    }
    public class AkAssetPlatformData : Object
    {
        public AkAssetPlatformData(ulong addr) : base(addr) { }
    ...
    {
        public AkAssetBase(ulong addr) : base(addr) { }
    ...
    {
        public AkAssetDataSwitchContainerData(ulong addr) : base(addr) { }
    ...
    {
        public AkAssetDataSwitchContainer(ulong addr) : base(addr) { }
    ...
    {
        public AkAudioEventData(ulong addr) : base(addr) { }
    ...
    {
        public AkGameObject(ulong addr) : base(addr) { }
        public AkAudioEvent AkAudioEvent { get { return this[nameof(AkAudioEvent)].As<AkAudioEvent>(); } set { this["AkAudioEvent"] = value; } }
    ...
    public class AkGeometryComponent : SceneComponent
    {
        public AkGeometryComponent(ulong addr) : base(addr) { }
    ...
    {
        public AkGroupValue(ulong addr) : base(addr) { }
    ...
    {
        public AkHololensInitializationSettings(ulong addr) : base(addr) { }
        public AkCommonInitializationSettingsWithSampleRate CommonSettings { get { return this[nameof(CommonSettings)].As<AkCommonInitializationSettingsWithSampleRate>(); } set { this["CommonSettings"] = value; } }
        public AkCommunicationSettingsWithSystemInitialization CommunicationSettings { get { return this[nameof(CommunicationSettings)].As<AkCommunicationSettingsWithSystemInitialization>(); } set { this["CommunicationSettings"] = value; } }
    ...
    {
        public AkHololensPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkInitBankAssetData : AkAssetDataWithMedia
    {
        public AkInitBankAssetData(ulong addr) : base(addr) { }
    ...
    {
        public AkInitBank(ulong addr) : base(addr) { }
    ...
    {
        public AkIOSPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkLinuxPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    public class AkLuminPlatformInfo : AkPlatformInfo
    {
        public AkLuminPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkMacPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkMediaAssetData : Object
    {
        public AkMediaAssetData(ulong addr) : base(addr) { }
    ...
    {
        public AkMediaAsset(ulong addr) : base(addr) { }
    ...
    {
        public AkLocalizedMediaAsset(ulong addr) : base(addr) { }
    }
    public class AkExternalMediaAsset : AkMediaAsset
    {
        public AkExternalMediaAsset(ulong addr) : base(addr) { }
    }
    public class AkPellegrinoPlatformInfo : AkPlatformInfo
    {
        public AkPellegrinoPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkDPXPlatformInfo : AkPellegrinoPlatformInfo
    {
        public AkDPXPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkPS5PlatformInfo : AkPellegrinoPlatformInfo
    {
        public AkPS5PlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkPS4PlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkRtpc(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkStateValue(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkSwitchPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkSwitchValue : AkGroupValue
    {
        public AkSwitchValue(ulong addr) : base(addr) { }
    }
    public class AkTrigger : AkAudioType
    {
        public AkTrigger(ulong addr) : base(addr) { }
    }
    public class AkTVOSInitializationSettings : Object
    {
        public AkTVOSInitializationSettings(ulong addr) : base(addr) { }
        public AkCommonInitializationSettingsWithSampleRate CommonSettings { get { return this[nameof(CommonSettings)].As<AkCommonInitializationSettingsWithSampleRate>(); } set { this["CommonSettings"] = value; } }
        public AkAudioSession AudioSession { get { return this[nameof(AudioSession)].As<AkAudioSession>(); } set { this["AudioSession"] = value; } }
        public AkCommunicationSettingsWithSystemInitialization CommunicationSettings { get { return this[nameof(CommunicationSettings)].As<AkCommunicationSettingsWithSystemInitialization>(); } set { this["CommunicationSettings"] = value; } }
        public AkAdvancedInitializationSettings AdvancedSettings { get { return this[nameof(AdvancedSettings)].As<AkAdvancedInitializationSettings>(); } set { this["AdvancedSettings"] = value; } }
    ...
    {
        public AkTVOSPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkWin32PlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkWin64PlatformInfo : AkPlatformInfo
    {
        public AkWin64PlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkWindowsPlatformInfo : AkWin64PlatformInfo
    {
        public AkWindowsPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkWinGDKPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkWinAnvilPlatformInfo : AkWinGDKPlatformInfo
    {
        public AkWinAnvilPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkXboxOneGDKPlatformInfo(ulong addr) : base(addr) { }
    }
    public class AkXboxOneAnvilPlatformInfo : AkXboxOneGDKPlatformInfo
    {
        public AkXboxOneAnvilPlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public AkXboxOnePlatformInfo(ulong addr) : base(addr) { }
    }
    ...
    {
        public PostEventAsync(ulong addr) : base(addr) { }
    ...
    {
        public PostEventAtLocationAsync(ulong addr) : base(addr) { }
        public Object Completed { get { return this[nameof(Completed)]; } set { this[nameof(Completed)] = value; } }
    ...
    public enum EAkHololensAudioAPI : int
    {
        Wasapi = 0,
        XAudio2 = 1,
        DirectSound = 2,
    ...
    {
        public AkGeometrySurfaceOverride(ulong addr) : base(addr) { }
        public AkAcousticTexture AcousticTexture { get { return this[nameof(AcousticTexture)].As<AkAcousticTexture>(); } set { this["AcousticTexture"] = value; } }
    ...
    {
        public AkGeometryData(ulong addr) : base(addr) { }
    ...
    {
        public AkTriangle(ulong addr) : base(addr) { }
    ...
    {
        public AkAcousticSurface(ulong addr) : base(addr) { }
    ...
    {
        public AkHololensAdvancedInitializationSettings(ulong addr) : base(addr) { }
        public uint AudioAPI { get { return this[nameof(AudioAPI)].GetValue<uint>(); } set { this[nameof(AudioAPI)].SetValue<uint>(value); } }
    ...
    {
        public AkPluginInfo(ulong addr) : base(addr) { }
        public Object Name { get { return this[nameof(Name)]; } set { this[nameof(Name)] = value; } }
    ...
    public class AkSpatialAudioSettings : Object
    {
        ...
        public bool EnableDirectPathDiffraction { get { return this[nameof(EnableDirectPathDiffraction)].Flag; } set { this[nameof(EnableDirectPathDiffraction)].Flag = value; } }
        ...
        public bool EnableTransmission { get { return this[nameof(EnableTransmission)].Flag; } set { this[nameof(EnableTransmission)].Flag = value; } }
    }
    ...
    {
        public AkCommunicationSettingsWithCommSelection(ulong addr) : base(addr) { }
    ...
    {
        public AkGeometrySurfacePropertiesToMap(ulong addr) : base(addr) { }
