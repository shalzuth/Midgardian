...
namespace SDK.Script.BuildPatchServicesSDK
{
    ...
    {
        public BuildPatchManifest(ulong addr) : base(addr) { }
    ...
    {
        public FileManifestData(ulong addr) : base(addr) { }
    ...
    {
        public ChunkPartData(ulong addr) : base(addr) { }
    ...
    {
        public SHAHashData(ulong addr) : base(addr) { }
    ...
    {
        public ChunkInfoData(ulong addr) : base(addr) { }
        public Guid Guid { get { return this[nameof(Guid)].As<Guid>(); } set { this["Guid"] = value; } }
    ...
    {
        public CustomFieldData(ulong addr) : base(addr) { }
