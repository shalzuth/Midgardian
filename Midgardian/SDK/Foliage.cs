...
namespace SDK.Script.FoliageSDK
{
    ...
    {
        public FoliageInstancedStaticMeshComponent(ulong addr) : base(addr) { }
    ...
    {
        public FoliageStatistics(ulong addr) : base(addr) { }
    ...
    {
        public FoliageType(ulong addr) : base(addr) { }
    ...
    {
        public FoliageType_Actor(ulong addr) : base(addr) { }
    ...
    {
        public FoliageType_InstancedStaticMesh(ulong addr) : base(addr) { }
    ...
    {
        public InstancedFoliageActor(ulong addr) : base(addr) { }
    }
    public class InteractiveFoliageActor : StaticMeshActor
    {
        public InteractiveFoliageActor(ulong addr) : base(addr) { }
    ...
    {
        public InteractiveFoliageComponent(ulong addr) : base(addr) { }
    }
    public class ProceduralFoliageBlockingVolume : Volume
    {
        public ProceduralFoliageBlockingVolume(ulong addr) : base(addr) { }
    ...
    {
        public ProceduralFoliageComponent(ulong addr) : base(addr) { }
    ...
    {
        public ProceduralFoliageSpawner(ulong addr) : base(addr) { }
    ...
    {
        public ProceduralFoliageTile(ulong addr) : base(addr) { }
        public ProceduralFoliageSpawner FoliageSpawner { get { return this[nameof(FoliageSpawner)].As<ProceduralFoliageSpawner>(); } set { this["FoliageSpawner"] = value; } }
    ...
    {
        public ProceduralFoliageVolume(ulong addr) : base(addr) { }
    ...
    {
        public FoliageVertexColorChannelMask(ulong addr) : base(addr) { }
    ...
    {
        public FoliageTypeObject(ulong addr) : base(addr) { }
    ...
    {
        public ProceduralFoliageInstance(ulong addr) : base(addr) { }
