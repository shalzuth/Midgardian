...
namespace SDK.Script.LandscapeSDK
{
    ...
    {
        public LandscapeLODStreamingProxy(ulong addr) : base(addr) { }
    }
    ...
    {
        public MaterialExpressionLandscapePhysicalMaterialOutput(ulong addr) : base(addr) { }
    ...
    {
        public PhysicalMaterialInput(ulong addr) : base(addr) { }
