...
namespace SDK.Script.LobbySDK
{
    ...
    {
        public LobbyBeaconClient(ulong addr) : base(addr) { }
    ...
    {
        public LobbyBeaconHost(ulong addr) : base(addr) { }
    ...
    {
        public LobbyBeaconState(ulong addr) : base(addr) { }
    ...
    {
        public LobbyBeaconPlayerState(ulong addr) : base(addr) { }
    ...
    {
        public LobbyPlayerStateInfoArray(ulong addr) : base(addr) { }
    ...
    {
        public LobbyPlayerStateActorInfo(ulong addr) : base(addr) { }
