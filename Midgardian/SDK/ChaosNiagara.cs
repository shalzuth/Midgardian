...
namespace SDK.Script.ChaosNiagaraSDK
{
    ...
    {
        public NiagaraDataInterfaceChaosDestruction(ulong addr) : base(addr) { }
    ...
    public class NiagaraDataInterfaceFieldSystem : NiagaraDataInterface
    {
        public NiagaraDataInterfaceFieldSystem(ulong addr) : base(addr) { }
        public Blueprint BlueprintSource { get { return this[nameof(BlueprintSource)].As<Blueprint>(); } set { this["BlueprintSource"] = value; } }
        public Actor SourceActor { get { return this[nameof(SourceActor)].As<Actor>(); } set { this["SourceActor"] = value; } }
        public IntVector FieldDimensions { get { return this[nameof(FieldDimensions)].As<IntVector>(); } set { this["FieldDimensions"] = value; } }
        public Vector MinBounds { get { return this[nameof(MinBounds)].As<Vector>(); } set { this["MinBounds"] = value; } }
        public Vector MaxBounds { get { return this[nameof(MaxBounds)].As<Vector>(); } set { this["MaxBounds"] = value; } }
    }
    ...
    {
        public ChaosDestructionEvent(ulong addr) : base(addr) { }
